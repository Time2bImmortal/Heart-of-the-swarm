...
multiple windows. 
Additionally, it allows integration with an Arduino board to per form closed-loop experiments. The parameters are 
...
def main(configuration):
    ...
    for i in range(num_detectors):
        ...
        detector = ArduinoDetector(Flag, ard_params["recording_file"], port=ard_params["port"],
                                   baudrate=ard_params["baudrate"], time_flag=ard_params["sensor_peek_frequency"],
implement_one_zero=ard_params["Implement_unequal_flag_shift"], ones_count=ard_params["count_ones_before_flag_shift"],
                                   zeros_count=ard_params["count_zero_before_flag_shift"])
